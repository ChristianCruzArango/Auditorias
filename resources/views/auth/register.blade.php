                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                ...
                                <input id="password-confirm" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password_confirmation" placeholder="Confirmar Password" required>
                            </div>
                        <br>
